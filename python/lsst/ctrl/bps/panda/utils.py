...
def _make_doma_work(
    ...
    if qnode_map_files:
        local_pfns.update(qnode_map_files)
...
def add_idds_work(config, generic_workflow, idds_workflow):
    ...
    if enable_qnode_map:
        ...
        qnode_map_files = {"qnodemap": qnode_map_file}
        files_to_pre_stage.update(qnode_map_files)
        ...
        for gwjob in jobs_by_label:
            ...
            if job_count == 1:
                ...
                work, files = _make_doma_work(
                    ...
                    qnode_map_files=qnode_map_files,
                )
            ...
            if "qgraphNodeId" in gwjob.cmdvals:
                qnode_map[pseudo_filename] = gwjob.cmdvals["qgraphNodeId"]
